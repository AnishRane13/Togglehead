    ...
    <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-24 text-xs leading-normal bg-white mt-4">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row">
        <div className="md:w-1/4 mb-4 md:mb-0">
          ...
          <p className="text-gray-500 mt-2 text-left lg:pr-16">Enquire about the examination & register for the exams</p>
        </div>
        {/* Add a faint line separator */}
        <div className="border-l border-gray-300 my-4 md:my-0 md:-ml-3 md:mr-12"></div>
