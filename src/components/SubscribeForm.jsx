  ...
  return (
    <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-16 bg-white shadow-lg rounded-lg overflow-hidden mt-12">
      <div className="md:flex md:items-center">
        <div className="p-6 md:w-7/12 pr-6 md:pr-28"> {/* Reduced right padding on mobile */}
          <h2 className="text-3xl font-medium mb-2 text-[#12406F]">Subscribe</h2>
          <p className="text-gray-600 mb-4 text-md pr-6 md:pr-28"> {/* Reduced right padding on mobile */}
          ...
          <form className="flex flex-col md:flex-row md:space-x-4">
            <input
              ...
              className="w-full md:w-auto flex-1 p-4 md:p-6 border border-gray-100 rounded-lg mb-4 md:mb-0 text-md shadow-md"
              style={{ height: '40px' }}
            />
            <button
              type="submit"
              className="relative flex items-center justify-center bg-[#12406F] text-white px-6 py-4 md:py-6 rounded-xl hover:bg-[#0E3557] transition-colors duration-300 text-sm font-medium"
